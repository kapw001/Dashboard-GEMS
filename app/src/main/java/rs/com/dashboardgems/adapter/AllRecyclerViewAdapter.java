...
public class AllRecyclerViewAdapter extends RecyclerView.Adapter<AllRecyclerViewAdapter.Row> {

    private static final String TAG = "RecyclerViewAdapter";
    private SharedPreferences sharedPreferences;

    public AllRecyclerViewAdapter(Context context, List<PersonData> list) {
        this.list = list;
    ...
    public AllRecyclerViewAdapter(Fragment context, List<PersonData> list) {
        this.list = list;
    ...
    public Row onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.rowall, parent, false);
        return new Row(view);
    }
