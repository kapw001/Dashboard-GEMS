...
public class RegionTab extends BaseFragment implements SchoolAdapter.SchoolInterface {
    private static final String TAG = "SchoolTab";
    private List<Schools> schoolsList;
    private SchoolAdapter schoolAdapter;
    private RegionBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.region, container, false);
...
//        int[] co = ColorTemplate.MATERIAL_COLORS;
    ...
    private void yearlyView() {
        ...
        binding.francebudget.setVisibility(View.GONE);
        binding.usabudget.setVisibility(View.GONE);
...
//        int francespent = getBudgetByExpense(resultList.get(4).getSchoolList());
//        int usaspent = getBudgetByExpense(resultList.get(3).getSchoolList());
//
...
//        int franceremain = getBudgetByRegion(resultList.get(4).getSchoolList()) - francespent;
//        int usaremain = getBudgetByRegion(resultList.get(3).getSchoolList()) - usaspent;
        ...
        binding.ukspent.setText("$" + "53.3 Mn" + "");
        binding.indiaspent.setText("$" + "32.8 Mn" + "");
        binding.uaespent.setText("$" + "47.6 Mn" + "");
        binding.francespent.setText("$" + "9.35 Mn" + "");
        binding.usaspent.setText("$" + "8.2 Mn" + "");

        binding.ukremaining.setText("$" + "110 Mn" + "");
        binding.indiaremaining.setText("$" + "60 Mn" + "");
        binding.uaeremaining.setText("$" + "128 Mn" + "");
        binding.franceremaining.setText("$" + "21 Mn" + "");
        binding.usaremaining.setText("$" + "13 Mn" + "");
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (name.toLowerCase().equalsIgnoreCase("france".toLowerCase())) {
                binding.francebudget.setVisibility(View.VISIBLE);
            }

            if (name.toLowerCase().equalsIgnoreCase("usa".toLowerCase())) {
                binding.usabudget.setVisibility(View.VISIBLE);
            }
